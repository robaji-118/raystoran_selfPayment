          ...
          <div className="p-fluid-6 space-y-fluid-4">
            ...
            <div className="flex items-center justify-between p-fluid-4 bg-gray-50 rounded-lg">
              <div className="space-y-fluid-1">
                ...
                <p className="text-gray-500 text-fluid-xs">
                  Inactive tables won&apos;t be visible for selection
                </p>
              </div>
            ...
            <div className="p-fluid-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-800 font-medium text-fluid-sm">
                    Current Table Status
                  </p>
                  <p className="text-blue-600 text-fluid-xs mt-fluid-1">
                    Table {table.tableNumber} is currently {table.status}
                  </p>
                </div>
                <div className={`px-fluid-2 py-fluid-1 rounded-full text-fluid-xs font-medium ${
