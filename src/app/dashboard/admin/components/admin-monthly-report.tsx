...
export default function AdminMonthlyReport() {
  ...
  const findTopDays = (orderList: Order[]) => {
    const dailyRevenue: Record<string, TopDay> = {};
    ...
    plugins: {
      legend: {
        ...
        labels: {
          color: "#6B7280",
          font: {
            size: Math.max(10, window.innerWidth * 0.00694), // fluid-xs equivalent
          },
          padding: Math.max(12, window.innerWidth * 0.01389), // fluid-5 equivalent
          usePointStyle: true,
          pointStyle: 'circle',
        }
      },
      tooltip: {
        ...
        borderColor: "#E5E7EB",
        borderWidth: 1,
        padding: Math.max(8, window.innerWidth * 0.00833), // fluid-3 equivalent
        boxPadding: Math.max(3, window.innerWidth * 0.00417), // fluid-1.5 equivalent
        usePointStyle: true,
        bodyFont: {
          size: Math.max(10, window.innerWidth * 0.00694), // fluid-xs
        },
        titleFont: {
          size: Math.max(10, window.innerWidth * 0.00694), // fluid-xs
        },
    ...
    scales: {
      y: {
        ...
        ticks: {
          ...
          padding: Math.max(8, window.innerWidth * 0.00833), // fluid-3
      ...
      <div className="">
        ...
        <div className="bg-white mb-fluid-6" style={{borderRadius: fluidSize(16)}}>
          <div className="flex items-center justify-between">
              ...
              <button className="flex items-center gap-fluid-2 px-fluid-4 py-fluid-2 cursor-pointer text-gray-600 hover:bg-gray-50 rounded-lg transition-colors text-fluid-sm border border-gray-200">
